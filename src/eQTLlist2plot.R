...
## Date: 2016-May-26
## Version: 0.0
## Usage: Rscript ~/neurogen/pipeline/RNAseq/src/eQTLlist2plot.R gene.snp.list
###############################################
require(MatrixEQTL)
...
# load("data.RData"); load("genes.RData"); G="ENSG00000232714.1"; S="kgp6377903_G:A"; genesnp = read.table("final.cis.eQTL.d1e6.p1e-2.xls", header=T, stringsAsFactors =F)
# load("data.RData"); load("genes.RData"); G="chr17_44218414_44219042"; S="rs17649553:43994648:C:T_C:T"; genesnp = read.table("final.cis.eQTL.d1e6.p1e-2.xls", header=T, stringsAsFactors =F)
...
apply(GS, 1, function(gs) {
  ...
  #write.table(t(snps$FindRow(S)$row),file = paste0("SNP.",S), quote=F, sep="\t", col.names = NA)
})
