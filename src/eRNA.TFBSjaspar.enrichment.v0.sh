...
# Usage: 
# bash $pipeline_path/src/eRNA.TFBSjaspar.enrichment.v0.sh ~/eRNAseq/externalData/TFBS/JASPARmotifscan.hg19.bed eRNA.JASPARmotifscan.txt
# bash $pipeline_path/src/eRNA.TFBSjaspar.enrichment.v0.sh ~/eRNAseq/externalData/TFBS/JASPARmotifscan.hg19.bed eRNA.JASPARmotifscan.2017.txt
...
do
	...
	for j in  eRNA-private eRNA-classI
	do
